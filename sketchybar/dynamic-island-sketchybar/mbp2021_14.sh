...
# Notch Size
P_DYNAMIC_ISLAND_DEFAULT_HEIGHT=50
P_DYNAMIC_ISLAND_DEFAULT_WIDTH=-34
P_DYNAMIC_ISLAND_CORNER_RADIUS=12
...
# Animation Settings
P_DYNAMIC_ISLAND_SQUISH_AMOUNT=2

#
## App Switch Island config
#
P_DYNAMIC_ISLAND_APPSWITCH_MAX_EXPAND_WIDTH=50 # Max size per character of app name
P_DYNAMIC_ISLAND_APPSWITCH_EXPAND_HEIGHT=50
P_DYNAMIC_ISLAND_APPSWITCH_CORNER_RAD=12 # Corner Radius
P_DYNAMIC_ISLAND_APPSWITCH_ICON_SIZE=1

#
## Volume Island config
#
P_DYNAMIC_ISLAND_VOLUME_MAX_EXPAND_WIDTH=50 # Max size when expanded
P_DYNAMIC_ISLAND_VOLUME_EXPAND_HEIGHT=50
...
P_DYNAMIC_ISLAND_BRIGHTNESS_EXPAND_HEIGHT=50
...
P_DYNAMIC_ISLAND_MUSIC_INFO_MAX_EXPAND_WIDTH=150 # Max size when expanded#
P_DYNAMIC_ISLAND_MUSIC_INFO_EXPAND_HEIGHT=50
P_DYNAMIC_ISLAND_MUSIC_INFO_CORNER_RAD=12
...
P_DYNAMIC_ISLAND_MUSIC_RESUME_EXPAND_HEIGHT=50
P_DYNAMIC_ISLAND_MUSIC_RESUME_CORNER_RAD=12

#
## WIFI Island config
#
P_DYNAMIC_ISLAND_WIFI_MAX_EXPAND_WIDTH=150 # Max size when expanded
P_DYNAMIC_ISLAND_WIFI_EXPAND_HEIGHT=50
P_DYNAMIC_ISLAND_WIFI_CORNER_RAD=12 # Corner Radius
...
#
P_DYNAMIC_ISLAND_BATTERY_MAX_EXPAND_WIDTH=150 # Max size when expanded
P_DYNAMIC_ISLAND_BATTERY_EXPAND_HEIGHT=50
P_DYNAMIC_ISLAND_BATTERY_CORNER_RAD=12 # Corner Radius
...
P_DYNAMIC_ISLAND_NOTIFICATION_EXPAND_HEIGHT=50
P_DYNAMIC_ISLAND_NOTIFICATION_CORNER_RAD=12        # Corner Radius
